...
public class FieldofView : MonoBehaviour
{
    ...
    public float MeshResolution { get => meshResolution; set => meshResolution = value; }
    [SerializeField]
    private int edgeResolveIterations;
    public int EdgeResolveIterations { get => edgeResolveIterations; set => edgeResolveIterations = value; }
    [SerializeField]
    private float edgeDstThreshold;
    public float EdgeDstThreshold { get => edgeDstThreshold; set => edgeDstThreshold = value; }
    ...
    void FindVisibleTargets()
    {
        ...
        for (int i = 0; i < targetsInViewRadius.Length; i++)
        {
            ...
            if (Vector3.Angle(transform.forward, dirToTarget) < ViewAngle / 2)
            {
                ...
                {
                    visibleTargets.Value.Add(target);
                }
            }
        }
    }
    ...
    void DrawFieldOfView()
    {
        ...
        BuildMesh(viewMesh, viewPoints.Count + 1, viewPoints);
    }

    private void BuildMesh(Mesh view, int vertexCount, List<Vector3> viewPoints)
    {
